...
[![Stars](https://img.shields.io/github/stars/hanuman-kshitij1001/My-AIML-Journey?style=social)](.)
[![Last Commit](https://img.shields.io/github/last-commit/hanuman-kshitij1001/My-AIML-Journey?color=blue)](.)
[![Repo Size](https://img.shields.io/github/repo-size/hanuman-kshitij1001/My-AIML-Journey?color=orange)](.)
...
|:-:|---|---|
| 00 | **Rough_Works** | 🧪 Scratch space — experiments, throwaway code, quick tests |
| 01 | **Python** | 🐍 Core Python fundamentals |
| 02 | **Numpy** | 🔢 Numerical computing with NumPy |
| 03 | **Pandas** | 🐼 Data wrangling with Pandas |
